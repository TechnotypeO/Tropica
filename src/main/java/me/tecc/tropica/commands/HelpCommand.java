...
public class HelpCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (sender instanceof Player) {//checks if the sender is a player
            ...
            net.md_5.bungee.api.chat.TextComponent two = new TextComponent(toColor("&e2&f. /unclaim &f- &7unclaim the land you're next to (&fHover to type)"));
            ...
            net.md_5.bungee.api.chat.TextComponent three = new TextComponent(toColor("&e3&f. /abandonallclaims &f- &7Unclaim all Land you ever claimed. (&fHover to type)"));
