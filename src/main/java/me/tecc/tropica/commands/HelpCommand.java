    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (sender instanceof Player) {//checks if the sender is a player
            ...
            Player player = (Player) sender;
                    ...
                    /*1 */net.md_5.bungee.api.chat.TextComponent one = new TextComponent(toColor("&a1&f. /gm help &f- &7Sends this message."));
            ...
            sender.sendMessage(toColor("&cYou must be a player to execute this command"));
        }
